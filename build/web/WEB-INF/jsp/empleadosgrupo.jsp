        ...
        <div class="container mt-4">
            ...
            <div class="card border-info">
                <div class="card-header bg-info text-white">
                    ...
                    <a href="agregarempleadosgrupo.htm" class="btn btn-secondary">Agregar Registro</a>
                    ...
                    <table border="1" class="table table-bordered table-striped table-hover text-center">
                        ...
                        <%
                            ...
                            try
                            {
                                ...
                                String Query="SELECT * FROM nm_empleados_grupo join nm_empleados "
                                        + " ON nm_empleados_grupo.Id_empleado  = nm_empleados.Id_empleado join nm_grupos "
                                        + " ON nm_empleados_grupo.Id_grupo = nm_grupos.Id_grupo where"
                                        + " Id_empleados_grupo like '%"+request.getParameter("Buscar")+"%' or "
                                    ...
                                    while(rs.next())
                                    {
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <c:forEach var="dato" items="${datos}"  begin="<%=rs.getInt("Id_empleados_grupo")-1%>" end="<%=rs.getInt("Id_empleados_grupo")-1%>">
