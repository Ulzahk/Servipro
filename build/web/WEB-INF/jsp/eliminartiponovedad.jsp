...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Eliminar Tipo de Novedad</title>
    ...
    <body>
        ...
        <div class="container mt-4">
            <h1 class="text-center">Eliminar Tipo de Novedad</h1>
            <br>
            <h3 class="text-center">¿Seguro que quiere eliminar este registro?</h3>
            <br>
            <div class="card border-info">
                <div class="card-header bg-info text-white">
                    <a href="tiponovedad.htm" class="btn btn-secondary"><i class="fas fa-arrow-left"></i></a>
                </div>
                <div class="card-body">
