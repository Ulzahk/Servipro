                        ...
                        <div class="form-row">
                            <c:forEach var="dato" items="${datos}">                                    
                                <div class="col-12 text-center btn-group">
                                    <a href="cargoempleado.htm" class="btn background-button font-weight-bold rounded" data-toggle="tooltip" title="Haz clic para regresar al menú perfil"><span>No, cancelar</span></a>
                                    <span>&nbsp;</span>
                                    <a href="<c:url value="confirmareliminarcargoempleado.htm?id_cargo=${dato.Id_cargo}"/>" class="btn btn-danger rounded ml-1"><b>Sí, eliminar</b></a>                                        
                                </div>
                            </c:forEach>
                        </div>
                    </div>
