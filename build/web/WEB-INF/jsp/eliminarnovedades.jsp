...
<html>
    ...
    <body>
        ...
        <div class="container mt-4">
         <h1 class="text-center">Eliminar Novedad</h1>
            <br>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a href="<c:url value="confirmareliminarnovedades.htm?id_novedad=${dato.Id_novedad}"/>"class="btn btn-danger"><b>Confirmar Eliminación</b></a>
                                </td>
                            </tr>
                            </c:forEach>
                        </tbody>    
