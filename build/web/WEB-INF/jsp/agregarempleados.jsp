        ...
        <div class="container mt-4">
            ...
            <div class="card border-info">
                ...
                <form:form method="post" commandName="empleados">
                    ...
                    <p>
                        <form:label path="tipo_documento"><b>Tipo Documento</b></form:label>
                        <form:select path="tipo_documento" cssClass="form-control">
                            <form:option value="CÉDULA DE CIUDADANÍA">CÉDULA DE CIUDADANÍA</form:option>
                            <form:option value="TARJETA DE IDENTIDAD">TARJETA DE IDENTIDAD</form:option>
                    ...
                    <p>
                        <form:label path="nombre"><b>Nombre</b></form:label>
                        <form:input path="nombre" cssClass="form-control"/>
                    </p>
                    <p>
                        <form:label path="telefono"><b>Teléfono</b></form:label>
                    ...
                    <p>
                        ...
                        <select id="id_ccostos" name="id_ccostos" class="form-control">
                            <option value="-1">SELECCIONE UN C.COSTOS</option>
                            <%
                                try
                                {
