...
public class ControlReportes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("btnGuardarEsta") != null) {
            ...
            request.getRequestDispatcher("Estadisticas/agregarreportes.jsp").forward(request, response);
    ...
    public void cargarEditarEsta(HttpServletRequest request,
        ...
        try {
            ...
            request.getRequestDispatcher("Estadisticas/editarreportes.jsp").forward(request, response);
    ...
    public void cargarComentarEsta(HttpServletRequest request,
        ...
        try {
            ...
            request.getRequestDispatcher("Estadisticas/comentarreportes.jsp").forward(request, response);
    ...
    public void cargarEliminarEsta(HttpServletRequest request,
        ...
        try {
            ...
            request.setAttribute("obclsEstadisticas", obclsEstadisticas);
            request.setAttribute("lstclsEstadisticas", lstclsEstadisticas);
            request.getRequestDispatcher("Estadisticas/eliminarreportes.jsp").forward(request, response);
