...
public class ControlEstadisticas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        } else if (request.getParameter("codigoMes") != null) {
            cargarEditarEstaMes(request, response);
        } else if (request.getParameter("btnEditarEstaMes") != null) {
            btnEditarEstaMes(request, response);
        } else if (request.getParameter("codigoAnio") != null) {
            cargarEditarEstaAnio(request, response);
        } else if (request.getParameter("btnEditarEstaAnio") != null) {
            btnEditarEstaAnio(request, response);
        }
    ...
    public void btnGuardarEsta(HttpServletRequest request,
        ...
        try {
            ...
            int extensionLista = 0;
            if(request.getParameter("extensionLista") != null){
                extensionLista = Integer.parseInt(request.getParameter("extensionLista"));
            }
            int extensionArreglo = extensionLista * 2;
            
            String[] ddlEmpleado = new String[extensionArreglo];
            String[] ddlDia1 = new String [extensionArreglo];
            String[] ddlDia2 = new String [extensionArreglo];
            String[] ddlDia3 = new String [extensionArreglo];
            String[] ddlDia4 = new String [extensionArreglo];
            String[] ddlDia5 = new String [extensionArreglo];
            String[] ddlDia6 = new String [extensionArreglo];
            String[] ddlDia7 = new String [extensionArreglo];
            String[] ddlDia8 = new String [extensionArreglo];
            String[] ddlDia9 = new String [extensionArreglo];
            String[] ddlDia10 = new String [extensionArreglo];
            String[] ddlDia11 = new String [extensionArreglo];
            String[] ddlDia12= new String [extensionArreglo];
            String[] ddlDia13 = new String [extensionArreglo];
            String[] ddlDia14 = new String [extensionArreglo];
            String[] ddlDia15 = new String [extensionArreglo];
            String[] ddlDia16 = new String [extensionArreglo];
            String[] ddlDia17 = new String [extensionArreglo];
            String[] ddlDia18 = new String [extensionArreglo];
            String[] ddlDia19 = new String [extensionArreglo];
            String[] ddlDia20 = new String [extensionArreglo];
            String[] ddlDia21 = new String [extensionArreglo];
            String[] ddlDia22= new String [extensionArreglo];
            String[] ddlDia23 = new String [extensionArreglo];
            String[] ddlDia24 = new String [extensionArreglo];
            String[] ddlDia25 = new String [extensionArreglo];
            String[] ddlDia26 = new String [extensionArreglo];
            String[] ddlDia27 = new String [extensionArreglo];
            String[] ddlDia28 = new String [extensionArreglo];
            String[] ddlDia29 = new String [extensionArreglo];
            String[] ddlDia30 = new String [extensionArreglo];
            String[] ddlDia31 = new String [extensionArreglo];
            String[] txtComentario = new String [extensionArreglo];
            
            
            
            for (int i = 1; i <= extensionArreglo; i++) {
    ...
    public void btnEditarEstaMes(HttpServletRequest request,
            HttpServletResponse response) throws IOException, ServletException {
        try {
            ...
            //Definición de parametros desde el controlador
            request.setAttribute("stMensaje", bl_clsEstadisticas.updateEstaMes(obclsEstadisticas));
            if (request.getAttribute("stMensaje").equals("Se realizo el proceso con exito")) {
                request.setAttribute("stTipo", "success");
            }
            ...
            BL.Estadisticas.clsMes bl_clsMes = new BL.Estadisticas.clsMes();
            request.setAttribute("lstclsMes", bl_clsMes.getMes());
            request.getRequestDispatcher("Estadisticas/editarestadisticasmes.jsp").forward(request, response);
        }
    }

    public void btnEditarEstaAnio(HttpServletRequest request,
            HttpServletResponse response) throws IOException, ServletException {
        try {
            ...
            BL.Estadisticas.clsAnio bl_clsAnio = new BL.Estadisticas.clsAnio();
            request.setAttribute("lstclsAnio", bl_clsAnio.getAnio());
            request.getRequestDispatcher("Estadisticas/editarestadisticasanio.jsp").forward(request, response);
        }
    }
    ...
    public void cargarEditarEstaMes(HttpServletRequest request,
            HttpServletResponse response) throws IOException, ServletException {
        try {
            BL.Estadisticas.clsEstadisticas bl_clsEstadisticas = new BL.Estadisticas.clsEstadisticas();
            ...
            for (Modelos.Estadisticas.clsEstadisticas elem : lstclsEstadisticas) {
                if (elem.getId_estadistica() == Integer.parseInt(request.getParameter("codigoMes"))) {
                    obclsEstadisticas = elem;
                    break;
                }
            }
    ...
    public void cargarEditarEstaAnio(HttpServletRequest request,
            HttpServletResponse response) throws IOException, ServletException {
        try {
            BL.Estadisticas.clsEstadisticas bl_clsEstadisticas = new BL.Estadisticas.clsEstadisticas();
            ...
            for (Modelos.Estadisticas.clsEstadisticas elem : lstclsEstadisticas) {
                if (elem.getId_estadistica() == Integer.parseInt(request.getParameter("codigoAnio"))) {
                    obclsEstadisticas = elem;
                    break;
                }
            }
