...
@Controller
@RequestMapping("editartiponovedad.htm")
public class ControlEditarTipoNovedad {
    
    TipoNovedadValidacion tipoNovedadValidacion;
    private JdbcTemplate jdbcTemplate;
    
    public ControlEditarTipoNovedad(){
    ...
    public ModelAndView tipoNovedad(HttpServletRequest request){
        ...
        mav.setViewName("editartiponovedad");
    ...
    BindingResult result, SessionStatus status, HttpServletRequest request){
        ...
        if(result.hasErrors()){
            ...
            int id_tipo_novedad=Integer.parseInt(request.getParameter("id_tipo_novedad"));
            this.jdbcTemplate.update("update tipo_novedad set descripcion=? where id_tipo_novedad=?",
    ...
    public TipoNovedad selectTipoNovedad(int id_tipo_novedad){
        ...
        String quer="select * from tipo_novedad where id_tipo_novedad='"+id_tipo_novedad+"'";
