...
public class ControlEditarEstadisticas {
    ...
    BindingResult result, SessionStatus status, HttpServletRequest request){
        ...
        if(result.hasErrors()){
            ...
            this.jdbcTemplate.update("update nm_estadistica set id_empleado=?, id_dia1=?, id_dia2=?, "
                    ...
                    + "id_dia17=?, id_dia18=?, id_dia19=?, id_dia20=?, id_dia21=?, id_dia22=?, id_dia22=?, "
                    + "id_dia23=?, id_dia24=?, id_dia25=?, id_dia26=?, id_dia27=?, id_dia28=?, id_dia29=?, "
                    + "id_dia30=? where id_estadistica=?", est.getId_empleado(), est.getId_dia1(), est.getId_dia2(), 
    ...
    public Estadisticas selectEstadisticas (int id_estadistica){
        ...
        String quer="select * from nm_estadisticas where id_estadistica='"+id_estadistica+"'";
        return (Estadisticas) jdbcTemplate.query(quer, new ResultSetExtractor<Estadisticas>(){
            public Estadisticas extractData(ResultSet rs)throws SQLException, DataAccessException{
                if(rs.next()){
                    ...
                    est.setId_dia2(rs.getInt("id_dia12"));
                    est.setId_dia3(rs.getInt("id_dia13"));
                    est.setId_dia4(rs.getInt("id_dia14"));
                    est.setId_dia5(rs.getInt("id_dia15"));
                    est.setId_dia6(rs.getInt("id_dia16"));
                    est.setId_dia7(rs.getInt("id_dia17"));
                    est.setId_dia8(rs.getInt("id_dia18"));
                    est.setId_dia9(rs.getInt("id_dia19"));
                    est.setId_dia10(rs.getInt("id_dia20"));
                    est.setId_dia11(rs.getInt("id_dia21"));
                    est.setId_dia2(rs.getInt("id_dia22"));
                    est.setId_dia3(rs.getInt("id_dia23"));
                    est.setId_dia4(rs.getInt("id_dia24"));
                    est.setId_dia5(rs.getInt("id_dia25"));
                    est.setId_dia6(rs.getInt("id_dia26"));
                    est.setId_dia7(rs.getInt("id_dia27"));
                    est.setId_dia8(rs.getInt("id_dia28"));
                    est.setId_dia9(rs.getInt("id_dia29"));
                    est.setId_dia10(rs.getInt("id_dia30"));
                }
                return est;
            }
        });
