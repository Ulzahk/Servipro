...
<html>
    <head>
        ...
        <title>Eliminar Centro de Costos</title>
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            ...
                            <c:forEach var="dato" items="${datos}">                                    
                                <div class="col-8 text-center">
                                    <a href="centrodecostos.htm" class="btn btn-info" data-toggle="tooltip" title="Haz clic para regresar al menú perfil" class="btn btn-info font-weight-bold"><span>No, cancelar</span></a>
                                    <span>&nbsp;</span>
