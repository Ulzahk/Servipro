...
<html>
    ...
    <body>
        ...
        <div class="container mt-4">
            <h1 class="text-center">Editar Responsable por Grupo</h1>
            <br>
            <div class="card border-info">
                <div class="card-header bg-info text-white">
                    <a href="responsablegrupo.htm" class="btn btn-secondary"><i class="fas fa-arrow-left"></i></a>
                </div>
                <div class="card-body">
                <form:form method="post" commandName="responsablegrupo">
                    <form:errors path="*" element="div" cssClass="alert alert-danger"/>
                    <p>
                        <label for="id_grupo"><b>Grupo</b></label>
                        <select id="id_grupo" name="id_grupo" class="form-control">
                            <option value="-1">SELECCIONE NUEVAMENTE UN GRUPO</option>
                            <%
                                try
                                {
                    ...
                    <p>
                        ...
                        <select id="id_usuario" name="id_usuario" class="form-control">
                            <option value="-1">SELECCIONE NUEVAMENTE UN USUARIO</option>
                            <%
                                try
                                {
                                    String Query="select * from nm_usuarios";
                                    Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
                                    Connection conn=DriverManager.getConnection("jdbc:sqlserver://10.0.0.98:1433;databaseName=sssacontable","contable19","contable19");
                                    Statement stm=conn.createStatement();
                                    ResultSet rs=stm.executeQuery(Query);
