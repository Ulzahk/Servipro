    ...
    <body>
        ...
        <div class="container mt-4">
            ...
            <div class="card border-info">
                ...
                <div class="card-body">
                <form:form action="list" method="post" commandName="usuarios">
        ...
        <option value="${passenger.id}"><c:out value="${passenger.name}" /></option>
                    ...
                    <p>
                        <form:label path="id_empleado"><b>Empleado</b></form:label>
                    ...
                    <p>
                        <form:label path="id_perfil"><b>Perfil</b></form:label>
