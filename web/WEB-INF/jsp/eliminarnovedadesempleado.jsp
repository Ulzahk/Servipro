...
<html>
    ...
    <body>
        ...
        <div class="container mt-4">
            <h1 class="text-center">Eliminar Novedades del Empleado</h1>
            <br>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a href="<c:url value="confirmareliminarnovedadesempleado.htm?id_novedad_empleado=${dato.Id_novedad_empleado}"/>"class="btn btn-danger"><b>Confirmar Eliminación</b></a>
                                </td>
                            </tr>
                            </c:forEach>
                        </tbody>    
