        ...
        <div class="container mt-4">
            ...
            <div class="card border-info">
                <div class="card-header bg-info text-white">
                    ...
                    <a href="agregarcentrodecostos.htm" class="btn btn-secondary">Agregar Registro</a>
                        ...
                        <tbody>
                            <c:forEach var="dato" items="${datos}">
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <div class="btn-group">
                                            <a href="<c:url value="editarcentrodecostos.htm?id_ccostos=${dato.Id_ccostos}"/>" class="btn btn-warning rounded mr-1 ml-4 "><i class="fas fa-edit"></i></a>
                                            <a href="<c:url value="eliminarcentrodecostos.htm?id_ccostos=${dato.Id_ccostos}"/>" class="btn btn-danger rounded mr-4"><i class="fas fa-trash-alt"></i></a>
                                        </div>
                                    </td>
                                </tr>
