                    ...
                    <table border="1" class="table table-bordered table-striped table-hover text-center table-responsive-sm">
                        <thead>
                            <tr>
                                ...
                                <th class="align-middle">Id Novedad</th>
                                <th class="align-middle">Detalle</th>
                                <th class="align-middle">Id tipo de facturación</th>
                            ...
                            try
                            {
                                ...
                                if(control!=null)
                                {
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="align-middle"><c:out value="${dato.Id_nov_emp2}"/></td>
                                            <td class="align-middle"><c:out value="${dato.Id_empleado}"/></td>
                                            <td class="align-middle"><c:out value="${dato.Id_novedad}"/></td>
                                            <td class="align-middle"><c:out value="${dato.Detalle}"/></td>
                                            <td class="align-middle"><c:out value="${dato.Id_tipo_novedad}"/></td>
                                            <td class="align-middle"><c:out value="${dato.Dia}"/></td>
                                            <td class="align-middle">
                                                <a href="<c:url value="editarperfil.htm?id_perfil=${dato.Id_nov_emp2}"/>"class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                                <a href="<c:url value="eliminarperfil.htm?id_perfil=${dato.Id_nov_emp2}"/>"class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                                            </td>
                                        </tr>
                                        </c:forEach>
                                    </tbody> 
