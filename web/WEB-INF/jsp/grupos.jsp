                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a href="<c:url value="editargrupos.htm?id_grupo=${dato.Id_grupo}"/>" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                    <a href="<c:url value="eliminargrupos.htm?id_grupo=${dato.Id_grupo}"/>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                            </c:forEach>
                        </tbody>    
