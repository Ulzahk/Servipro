...
<html>
    ...
    <body>
        ...
        <div class="container mt-4">
            <h1 class="text-center">Tipo de Novedad</h1>
            <br>
                    ...
                    <table border="1" class="table table-bordered table-striped table-hover text-center">
                        <thead>
                            <tr>
                                ...
                                <th class="align-middle">Tipo Novedad</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<c:url value="editartiponovedad.htm?id_tipo_novedad=${dato.Id_tipo_novedad}"/>" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                    <a href="<c:url value="eliminartiponovedad.htm?id_tipo_novedad=${dato.Id_tipo_novedad}"/>"class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                            </c:forEach>
                        </tbody>    
