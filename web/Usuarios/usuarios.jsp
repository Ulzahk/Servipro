            ...
            <div class="card border-info">
                <div class="card-header bg-info text-white">
                    <form action="controlusuarios" method="post">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control rounded-left" name="txtUsuBuscar" id="txtEmplBuscar" placeholder="Buscar en Servisoft S.A."/>
                            <div class="input-group-append">
                                <button type="submit" Value="Buscar" class="btn btn-secondary rounded-right" data-toggle="tooltip" title="Haz clic para buscar" name="btnUsuBuscar"><i class="fas fa-search"></i></button>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="card-body">
                    <table id="table-id" border="1" class="table table-bordered table-striped table-hover text-center table-responsive-lg">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-8 ml-2">
                                    <b>
                                        ...
                                        <span>Registros Existentes: <%=lstclsUsuarios.size()%></span>
                                    </b>
                        ...
                        <tr>
                            <td class="align-middle"><b>Usuarios</b></td>
                            <td class="align-middle"><b>Empleado</b></td>
                            <td class="align-middle"><b>Contraseña</b></td>
