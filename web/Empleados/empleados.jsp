                ...
                <div class="card-header bg-info text-white">
                    <form action="empleados" method="post">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control rounded-left" name="txtEmplBuscar" id="txtEmplBuscar" placeholder="Buscar en Servisoft S.A."/>
                            <div class="input-group-append">
                                <button type="submit" Value="Buscar" class="btn btn-secondary rounded-right" data-toggle="tooltip" title="Haz clic para buscar" name="btnEmplBuscar"><i class="fas fa-search"></i></button>
                            </div>
                        </div>
                    </form>
                </div>
