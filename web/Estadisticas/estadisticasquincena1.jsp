                    ...
                    <form action="estadisticas" method="post">
                        ...
                        <div class="input-group mt-2">
                            ...
                            <div class="input-group-append">
                                <button type="submit" Value="Buscar" class="btn btn-secondary rounded-right" data-toggle="tooltip" title="Haz clic para buscar" name="btnBuscarEstaQuincena1"><i class="fas fa-search"></i></button>                            
                            </div>
                        </div>                          
                    </form>
                </div>
