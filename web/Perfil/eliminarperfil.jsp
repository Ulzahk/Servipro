                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-8 text-center">
                                    ...
                                    <h4 class="font-weight-bold">¿Estás seguro que quieres eliminar este registro?</h4>
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-12 text-center btn-group">
                                    ...
                                    <span>&nbsp;</span>
                                    <input type="submit" value="Sí, eliminar" class="btn btn-danger font-weight-bold rounded ml-1" name="btnPerfEliminar"/>
