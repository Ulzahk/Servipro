...
<html>
    ...
    <body>
        ...
        %>
        <div class="container">    
            <h3 class="text-center">Editar Dia 7</h3>
            <br>
                ...
                <div class="card-body">
                    <form action="estadisticas" method="POST">                           
                                ...
                                <div class="col-12">
                                    ...
                                    <select class="form-control" name="ddlDia7">
                                        ...
                                        <option value="<%=elem.getId_dia7()%>"
                                                <%=obclsEstadisticas.getObId_dia1()!= null ? obclsEstadisticas.getObId_dia7().getId_dia7()== elem.getId_dia7()? "selected" : "" : ""%>>
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-12">
                                    <input type="submit" value="Guardar" class="btn btn-info" name="btnEditarEstaDia7"/>
